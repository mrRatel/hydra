...
layui.define(["laytpl", "form", "util"], function (s) {
    ...
    p.prototype.getIndexById = function (v) {
        ...
        function u(y, z) {
            for (var x = 0; x < y.length; x++) {
                if (y[x][t.tree.idName] === v) {
                    return z !== undefined ? z + "-" + x : x
                }
                if (y[x][t.tree.childName]) {
                    var w = u(y[x][t.tree.childName], z !== undefined ? z + "-" + x : x);
                    if (w) {
                        return w
                    }
                }
    ...
    p.prototype.filterData = function (y) {
        ...
        x.not(".ew-tree-table-filter-hide").not(".ew-tree-tb-hide").each(function () {
            var C = g(this).data("index"), D = true;
            ...
            if (D) {
                g(this).addClass("ew-tree-table-filter-hide")
            }
        });
        A.$loading.hide();
